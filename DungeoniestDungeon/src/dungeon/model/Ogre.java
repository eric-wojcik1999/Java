...
public class Ogre implements Enemy 
{
    ...
    *  IMPORT: none                                                           *
    *  EXPORT: none                                                           *
    *  ASSERTION: An Ogre object initialised with default values              *
    ***************************************************************************/ 
    ...
    *  EXPORT: none                                                           *
    *  ASSERTION: An Ogre object initialised with valid parameters            *
    ***************************************************************************/

    public Ogre(String inSpeciesName, int inMaxHP, int inCurrHP, int inMaxAttack, 
int inMinAttack, int inMaxDefence, int inMinDefence, int inGold) 
    ...
    *  20% chance to simulate attacking twice in a row                        *
    ***************************************************************************/

    public int useAbility()
    {
	System.out.println("\n>Attack Twice!");
        return (int) (Math.random()*((getMaxAttack() - getMinAttack())+1)+getMinAttack()); 
    }
